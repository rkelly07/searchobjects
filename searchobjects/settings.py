# Django settings for searchobjects project.


 #PROJECT_ROOT
#   Absolute path to the directory of this file (settings.py).
#   Will be helpful when absolute filesystem paths are required.
#  In Pramod's system, PROJECT_ROOT = /home/pramod/research/video_analysis/trunk/searchobjects
import os
...
SECRET_KEY = 'px^@1#o(ks0!3gu=a7*xg167nac(x(l5a)2v8m9s@y=mi08=(f'
...
ROOT_URLCONF = 'searchobjects.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'searchobjects.wsgi.application'
